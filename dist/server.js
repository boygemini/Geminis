...
app.get("/shop", function (req, res) {
  var path = resolve(process.env.STATIC_DIR + "pages/shop.html");
  res.sendFile(path);
});
app.get("/product", function (req, res) {
  var path = resolve(process.env.STATIC_DIR + "pages/product.html");
  res.sendFile(path);
});
app.get("/cart", function (req, res) {
  var path = resolve(process.env.STATIC_DIR + "pages/cart.html");
  res.sendFile(path);
});
app.get("/checkout", function (req, res) {
  var path = resolve(process.env.STATIC_DIR + "pages/checkout.html");
  res.sendFile(path);
});
...
app.post("/create-payment-intent", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _yield$req$body, totalItemPrice, paymentIntent;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          totalItemPrice = _yield$req$body.totalItemPrice;
          _context.next = 6;
...
app.post("/webhook", /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var data, eventType, event, signature;
