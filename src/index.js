...
app.get("/shop", (req, res) => {
	const path = resolve(process.env.STATIC_DIR + "pages/shop.html");
	res.sendFile(path);
});

app.get("/product", (req, res) => {
	const path = resolve(process.env.STATIC_DIR + "pages/product.html");
	res.sendFile(path);
});

app.get("/cart", (req, res) => {
	const path = resolve(process.env.STATIC_DIR + "pages/cart.html");
	res.sendFile(path);
});
