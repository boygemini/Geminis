...
class displayProduct {
	...
	static createItem(event, holderClass, category, sub) {
		...
		for (let i = 0; i <= 9; i++) {
			itemCreated += `<a href="product?item=${category[i].id}" class="sell-box sel-box" data-id=${category[i].id}>
	...
	static displayRecentItems(category, sub) {
		...
		for (let i in category) {
			itemCreated += `<a href="product?item=${category[i].id}" class="sell-box sel-box" id=${i} data-id=${category[i].id} onclick = "viewProduct(event)">
	...
	static displayWeeklyFeatured(category, sub) {
		...
		for (let i in category) {
			itemCreated += `<a href="product?item=${category[i].id}" class="sell-box sel-box" data-id=${category[i].id} onclick = "viewProduct(event)">
