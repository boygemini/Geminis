...
[...document.querySelectorAll("#games")].forEach((btn) =>
	btn.addEventListener("click", (e) => {
		Gamings();
		emptyParameters();
		window.location = "shop?category=gaming&Order=Random&Page=0";
	})
);
...
[...document.querySelectorAll("#phones")].forEach((btn) =>
	btn.addEventListener("click", (e) => {
		cellPhones();
		emptyParameters();
		window.location = "shop?category=cellphones&Order=Random&Page=0";
	})
);
...
[...document.querySelectorAll("#coms")].forEach((btn) =>
	btn.addEventListener("click", (e) => {
		Computers();
		emptyParameters();
		window.location = "shop?category=computers&Order=Random&Page=0";
	})
);
...
[...document.querySelectorAll("#spks")].forEach((btn) =>
	btn.addEventListener("click", (e) => {
		Speakers();
		emptyParameters();
		window.location = "shop?category=speakers&Order=Random&Page=0";
	})
);
...
[...document.querySelectorAll("#tele")].forEach((btn) =>
	btn.addEventListener("click", (e) => {
		TVs();
		emptyParameters();
		window.location = "shop?category=tv&Order=Random&Page=0";
	})
);
